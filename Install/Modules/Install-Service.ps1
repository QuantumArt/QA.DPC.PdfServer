function Install-Service
{
  ...
  New-Service -name $name -binaryPathName "$installFolder\$binaryName" -Description $description -displayName $displayName -startupType Automatic -credential $mycreds | Out-Null
