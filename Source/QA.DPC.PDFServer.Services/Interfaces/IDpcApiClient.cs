...
namespace QA.DPC.PDFServer.Services.Interfaces
{
    ...
    {
        Task<string> GetProductJson(string slug, NameValueCollection parameters, bool allFields, SiteMode siteMode, string[] fields = null);
        ...
        Task<T> GetProduct<T>(string slug, NameValueCollection parameters, bool allFields, SiteMode siteMode, string[] fields = null);
